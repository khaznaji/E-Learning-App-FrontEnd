...
export class StudentProfileComponent implements OnInit {
  ...
  constructor(private http: HttpClient ,private  sr : UserService ,private formBuilder: FormBuilder,private router: Router) { this.UpdaImage = this.formBuilder.group({
    Photo: ''
  })}
