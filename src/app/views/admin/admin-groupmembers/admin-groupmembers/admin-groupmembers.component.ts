...
export class AdminGroupmembersComponent implements OnInit{
  ...
  @ViewChild('confirmationDeleteDialog') confirmationDeleteDialog!: TemplateRef<any>;
  ...
  constructor(
    ...
    private fr: FormationsService ,  private certificateService: CertificatService,
  ...
  generateCertificates(groupId: number, month: string, periode: string): void {
    this.certificateService.genererCertificatForGroup(groupId, month, periode).subscribe(
      () => {
