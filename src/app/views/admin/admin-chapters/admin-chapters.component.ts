...
export class AdminChaptersComponent implements OnInit {
  ...
  updateChapter(chapter: any) {
    Swal.fire({
      ...
      html:
        '<input id="title" class="swal2-input" placeholder="Title" value="' + chapter.title + '">' +
        '<textarea id="description" class="swal2-input" placeholder="Description">' + chapter.description + '</textarea>',
      focusConfirm: false,
      preConfirm: () => {
