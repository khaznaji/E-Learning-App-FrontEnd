...
export class ChaptersService {
  ...
  deleteChapters(id:any){
    return this.http.delete(`${environement.BASE_URL}/chapters/deleteChapters/${id}`);
  }
  updateChapters(id: number, updatedChapters: any): Observable<any> {
    return this.http.put(`${environement.BASE_URL}/chapters/updateChapters/${id}`, updatedChapters);
  }
