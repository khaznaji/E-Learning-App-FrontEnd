...
//delete feedback
    deleteFeedback(id: any): Observable<any> {
      return this.http.delete(`${environement.BASE_URL}/Feedback/deleteFeedback/${id}`);
    }


  pubunpub(id:any){
    return this.http.patch(`${environement.BASE_URL}/Feedback/updateFeedbackPosted/${id}`,null);
  }

  getPostedFeedback()
  {
    return this.http.get(`${environement.BASE_URL}/Feedback/getFeedbackByPosted`);
  }
}
