...
children:[
  ...
  {path:'projectgroup',loadChildren:()=>import('./views/coach/coach-students-table/coach-students-table.module').then(m=>m.CoachStudentsTableModule)},
  {path:'projectmember',loadChildren:()=>import('./views/coach/project-member/project-member-routing.module').then(m=>m.ProjectMemberRoutingModule)},

  {path:'project-member-details',loadChildren:()=>import('./views/coach/coach-student-projects/coach-student-projects.module').then(m=>m.CoachStudentProjectsModule)},
